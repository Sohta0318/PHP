  ...
  ?>
      ...
      <div class="well">
        ...
        <form role="form" action="post.php?p_id=<?php echo $post_id;?>" method="post">
          <div class="form-group"><label for="author">Author</label><input type="text" class="form-control"
              name="comment_author"></div>
          <div class="form-group"><label for="email">Email</label><input type="email" class="form-control"
              name="comment_email"></div>
          <div class="form-group"><label for="comment">Your Comment</label><textarea class='form-control' rows="3"
              name="comment_content"></textarea></div>
          <button class="btn btn-primary" type="submit" name="create_comment">Comment</button>
        </form>
      </div>
